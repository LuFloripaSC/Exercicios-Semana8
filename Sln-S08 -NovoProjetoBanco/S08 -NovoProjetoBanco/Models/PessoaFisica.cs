...
namespace S08__NovoProjetoBanco.Models
{
    public class PessoaFisica : Cliente
    {
        ...
        public PessoaFisica(string email, string telefone, string endereco, int numeroConta, List<Transacao> extrato, string nome, string cpf, DateTime dataNascimento) : base(email, telefone, endereco, numeroConta, extrato)
        {
            Email = email;
            Telefone = telefone;
            Endereco = endereco;
        ...
        public int Idade
        {
            get { return (int)(Math.Floor((DateTime.Now - DataNascimento).TotalDays / 365.25)); } private set { }
        }
